            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formProduto" method="post" class="form-horizontal" >
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="precoCompra" class="money" type="text" name="precoCompra" value="<?php echo set_value('precoCompra'); ?>" onblur="calculaPrecoVenda();" />
                        </div>
                    </div>
                     ...
                     <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="percentualPrecoVenda" class="money" type="text" name="percentualPrecoVenda" value="<?php echo set_value('percentualPrecoVenda'); ?>" placeholder="Ex. 5.00 %" onblur="calculaPrecoVenda();"/><strong>%  </strong><span style="color: red">Porcentagem aplicada no preço de venda</span>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="precoVenda" class="money" type="text" name="precoVenda" onblur="calculaMargemLucro();" value="<?php echo set_value('precoVenda'); ?>"  />
                        </div>
                    </div>
